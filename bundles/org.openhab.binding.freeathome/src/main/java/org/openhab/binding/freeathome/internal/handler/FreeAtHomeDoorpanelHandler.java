...
public class FreeAtHomeDoorpanelHandler extends FreeAtHomeBaseHandler {
    ...
    private FreeAtHomeDoorpanelConfig m_Configuration = new FreeAtHomeDoorpanelConfig();
    ...
    @Override
    public void setUp() {
        m_Configuration = getConfigAs(FreeAtHomeDoorpanelConfig.class);

        // Fetch bridge on initialization to get proper state
        FreeAtHomeBridgeHandler bridge = getFreeAtHomeBridge();
        if (bridge != null) {
            m_UpdateChannels.add(new FreeAtHomeUpdateChannel(this, FreeAtHomeBindingConstants.DOORSWITCH_THING_CHANNEL,
